...
function act4_verify_tab1() {
  let val1: HTMLInputElement = <HTMLInputElement> document.getElementById('v-input');
  let val2: HTMLInputElement = <HTMLInputElement> document.getElementById('t-input');
  let val3: HTMLInputElement = <HTMLInputElement> document.getElementById('ti-input');
  let val4: HTMLInputElement = <HTMLInputElement> document.getElementById('to-input');
